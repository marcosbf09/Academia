    ...
    public void CadastrarAdministrador(){
        ...
        try {
            ...
            while(x==1){
                ...
                System.out.println("\nDeseja continuar cadastrando administradores? 1-Sim, 2-Nao");
                op = entrada.nextInt();
    ...
    public void consultarAdm(){
        ...
        try {
            ...
            int cpf;
                ...
                Administrador b = em.find(Administrador.class, cpf);
                System.out.println("\nNome: "+b.getNome());
    ...
    public void atualizarAdm(){
        ...
        try {
            ...
            int id;
                ...
                Administrador a = em.find(Administrador.class, cpf);
                entrada.nextLine();
